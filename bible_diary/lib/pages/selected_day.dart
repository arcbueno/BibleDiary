...
class SelectedDay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var title = currentDate.day.toString() + " de " + utils.months[currentDate.month] + " de " + currentDate.year.toString(); 
      ...
      child: Column(
        children: <Widget>[
          ...
          TextFormField(
            ...
            maxLines: null,
            decoration: InputDecoration(
              hintText: 'O que aprendeu',
              labelText: 'O que aprendeu'
            ),
